...
# DASHBOARD
　現在、企画のページのプレビューを作成中です。Nuxt3+Bootstrapで作っています。
# 方針
...
- 2022年
  ...
  - 6月
    - 21日  
    Nuxt3はやっぱ開発中ってのもあるし使わないかも。VueCliのRouter弄ってSPA作ったほうがよさそう。PWAもサポートされてるしね。Vuexは使わずに流行りのPiniaでやりたい。流行ってるのか知らんけど。